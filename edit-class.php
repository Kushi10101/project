...
<html lang="en">
    <head>
        ...
        <title>vCP Admin Update batches</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Update Student batches</h2>
                                </div>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Batch Name in Numeric</label>
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- 3,4,6 etc</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
